from pyflink.datastream import (StreamExecutionEnvironment, DataStream, CheckpointingMode, ExternalizedCheckpointCleanup)
...
if __name__ == "__main__":
    ...
    (stream_environment.get_checkpoint_config()
     .set_externalized_checkpoint_cleanup(ExternalizedCheckpointCleanup.RETAIN_ON_CANCELLATION))
